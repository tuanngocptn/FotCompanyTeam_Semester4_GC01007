 ...
 * @author Panda
 */
public class DoUpdateLstWorkerCusActionSupport extends ActionSupport {
    ...
    public DoUpdateLstWorkerCusActionSupport() {
    }
    ...
    public String execute() throws Exception {
        ...
        if (dataProcess.updateListWorkerOrder(lstWorker, codeOrderDo, "wait")) 
            return "index";
