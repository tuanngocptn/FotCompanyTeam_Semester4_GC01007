...
public class OrderActionSupport extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        if (db.addNewOrder(nameCustomer, emailCustomer, phone, location, codeCareer, quantityWorker, startDate, endDate, "wait", lstWorker)) {
            ...
            String  content = "<p>Dear: "+nameCustomer+"<br><br> chúng tôi đã nhận được thông tin về đơn đặt hàng của bạn như sau</p><table border='1' ><tr><th>Tên Khách Hàng</th><th>Số Điện Thoại</th><th>Địa Điểm</th><th>Mã CV</th><th>Tổng CN</th><th>Ngày Bắt Đầu</th><th>Ngày Kết Thúc</th></tr><tr><td>"+nameCustomer+"</td><td>"+phone+"</td><td>"+location+"</td><td>"+codeCareer+"</td><td>"+quantityWorker+"</td><td>"+startDate+"</td><td>"+endDate+"</td></tr></table><p>cảm ơn bạn đã sử dụng dịch vụ của chúng tôi bạn có thể kiểm tra tiến độ công việc của bạn tại link sau: <br> http://localhost:8084/ProjectSem4Strut2/checkHang?emailCustomer="+emailCustomer+" <br><br>Thanks and Best Regards!</p>";
