...
INSERT INTO tblCareer VALUES	('adm',N'admin',100000)
								,('xd',N'Xây Dựng',120000)
								,('bm',N'Bốc Mộ',110000)
								,('hbp',N'Hút Bể Phốt',100000)
								,('kcbt',N'Khoan Cắt Bê Tông',150000)



INSERT INTO tblWorker(_codeWorker,_codeCareer,_user,_pass,_name,_avatar,_dateOfBirth,_phone,_email,_address) VALUES	
						('adm1','adm','admin','admin',N'Ass Văn Min','images/avatars/Admin.jpg','2016-12-25',84912345678,'admin@gmail.com','HN'),
...
INSERT INTO tblOrder VALUES		(N'Ngô Thị Hương Giang','giangnth5@fe.edu.vn',84982336969,N'Văn Quán Hà Đông','xd',1,'2016-08-10','2016-08-11','wait','',100000),
								(N'Vũ Như Quỳnh','quynhvn2@fe.edu.vn',84969681990,N'Khu Đô Thị Mỹ Đình 1','xd',2,'2016-08-11','2016-08-12','wait','',0),
								(N'Trấn Thành','thanhht@gmai.com',84932345287,N'Trần Duy Hưng','xd',3,'2016-08-12','2016-08-13','wait','',0),
								(N'Hari Won','hariyeutiendat@gmai.com',84992125225,N'Seoul','xd',4,'2016-08-13','2016-08-14','wait','',0),
								(N'Nguyễn Cao Kỳ Duyên','duyennck@gmai.com',841622486668,N'Cầu Giấy','xd',5,'2016-08-14','2016-08-15','wait','',200000)
